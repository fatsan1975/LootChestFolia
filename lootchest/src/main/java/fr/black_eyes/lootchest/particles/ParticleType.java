...
public interface ParticleType {
     ...
     */
    default void spawn(Location location, int count) {
        spawn(location.getWorld(), location.getX(), location.getY(), location.getZ(), count);
    }
     ...
     */
    default void spawn(Location location, int count, double offsetX, double offsetY, double offsetZ) {
        spawn(location.getWorld(), location.getX(), location.getY(), location.getZ(), count, offsetX, offsetY, offsetZ);
    }
     ...
     */
    default void spawn(Location location, int count, double offsetX, double offsetY, double offsetZ, double extra) {
        spawn(location.getWorld(), location.getX(), location.getY(), location.getZ(), count, offsetX, offsetY, offsetZ, extra);
    }
